...
/** 临时日志过期清理扫描间隔（毫秒）；独立于保留期清理（24h），只 DELETE 不 VACUUM，避免频繁全库锁。定时器按 logMode 自适应启停（见 temp-cleanup-scheduler），非 temporary 模式存量清完即停 */
export const TEMP_LOG_CLEANUP_INTERVAL_MS = 180_000;
